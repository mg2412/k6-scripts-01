// scripts/students.js — 37,000 students Login → Model → Logout
// Mirrors PLAT-4287-A2-Login-Students.jmx (Phase 3, three enabled samplers).
import { SharedArray } from 'k6/data';
import papaparse from 'https://jslib.k6.io/papaparse/5.1.1/index.js';
import { studentFlow } from '/lib/flow.js';

const TARGET_VUS       = parseInt(__ENV.TARGET_VUS       || '37000', 10);
const RAMP_SECONDS     = parseInt(__ENV.RAMP_SECONDS     || '300',   10);
const HOLD_SECONDS     = parseInt(__ENV.HOLD_SECONDS     || '600',   10);
const RAMPDOWN_SECONDS = parseInt(__ENV.RAMPDOWN_SECONDS || '60',    10);
const CSV_PATH         = __ENV.STUDENTS_CSV || '/data/students.csv';

const credentials = new SharedArray('students', function () {
...
export const options = {
  ...
  userAgent: 'k6-plat4287-students/1.0',
};
